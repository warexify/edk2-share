...
class UefiDriverWizardUefiDriverWizard( UefiDriverWizard.UefiDriverWizard ):
  ...
  def aboutOnMenuSelection( self, event ):
    ...
    aboutInfo.SetName("UEFI Driver Wizard")
    aboutInfo.SetVersion("0.11")
    aboutInfo.SetCopyright("(C) 2012-2018 Intel Corporation. All rights reserved")
    aboutInfo.SetIcon(wx.Icon(os.path.join(os.path.abspath(sys.path[0]), 'Logo.png'), wx.BITMAP_TYPE_PNG))
...
Credentials.
''')
    aboutInfo.SetWebSite("http://www.tianocore.org", "EDK II home page")
...
''')
    aboutInfo.SetWebSite("http://opensource.org/licenses/bsd-license.php", "BSD License")
    wx.adv.AboutBox(aboutInfo)
